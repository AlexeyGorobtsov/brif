...
/**
    ...
    public function setDesktop($value) {$this->variables["desktop"] = $value; }
    public function getDesktop() { return $this->variables["desktop"]; }
    public function setIpad($value) {$this->variables["ipad"]= $value;}
    public function getIpad() { return $this->variables["ipad"]; }
