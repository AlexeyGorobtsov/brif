...
/**
    ...
    public function setConsumers($value) {$this->variables["consumers"]= $value;}
    public function getConsumers() { return $this->variables["consumers"]; }
    public function setRepresentatives($value) {$this->variables["representatives"]= $value; }
    public function getRepresentatives() { return $this->variables["representatives"]; }
    public function setOrganizations($value) {$this->variables["organizations"]= $value;}
    public function getOrganizations() { return $this->variables["organizations"]; }
    public function setFields($value) {$this->variables["fields"]= $value;}
    public function getFields() { return $this->variables["fields"]; }
