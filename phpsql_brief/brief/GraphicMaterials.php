...
/**
    ...
    public function setFree($value) {$this->variables["free"] = $value;}
    public function getFree() { return $this->variables["free"]; }
    public function setPaid($value) {$this->variables["paid"] = $value; }
    public function getPaid() { return $this->variables["paid"]; }
    public function setPhoto_session($value) {$this->variables["photo_session"] = $value; }
    public function getPhoto_session() { return $this->variables["photo_session"]; }
    public function setCreation_unique($value) {$this->variables["creation_unique"] = $value; }
    public function getCreation_unique() { return $this->variables["creation_unique"];}
